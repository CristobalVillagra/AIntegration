...
function LoginForm({ onSwitchToRegister, onSubmit, isLoading }: LoginFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // =========================================================================
    // AQUÍ SE LLAMARÁ A SUPABASE
    // La función onSubmit ya tiene la lógica preparada para:
  ...
  return (
    <>
      ...
      {/* Social buttons - TODO: Integrar con supabase.auth.signInWithOAuth */}
...
function RegisterForm({ onSwitchToLogin, onSubmit, isLoading }: RegisterFormProps) {
  ...
  return (
    <>
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground">Registrate para acceder a todos los servicios</p>
      </div>
